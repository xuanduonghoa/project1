			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<div><input type="text" id="myInput" onkeyup="myFunction()" placeholder="Tìm kiếm mã lớp tín chỉ">	      
	 <input type="text" id="myInputHT" onkeyup="myFunctionHT()" placeholder="Tìm kiếm tên học phần"></div>
						<table id="myTable"
						    ...
						    <tr>
								...
								<th data-field="hd" data-sortable="true"><b>Chi tiết</b></th>
						    </tr>
                            </thead>
                            <tbody>
							<?php
            $stt = 1 ;
            $sql = "SELECT *  FROM courselist as c,  loptc l, giangvien g where g.magv=l.magv and c.MaHP=l.mahp and g.username='$username' and l.hocki='$hocki'	order by l.thu,l.tgbd";
            $query = mysqli_query($conn,$sql);
          ...
          ?>
            <tr>
			 ...
			 <td><a class="btn btn-primary" href="ttloptc.php?maloptc=<?php echo $data["maloptc"];?>">Xem</a></td>
            </tr>
	<?php }?>
          </tbody>										
					</table>
